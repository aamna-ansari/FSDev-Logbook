...
addNoteButton.addEventListener("click", () => {
  ...
  noteRender.innerHTML = `<div class="absolute top-3 right-3 flex gap-2">
    <button class="text-2xl text-gray-500 hover:text-blue-700 cursor-pointer">
    <i class="fa-solid fa-pen-to-square"></i>
    </button>

            <button class=" text-2xl deleteBtn text-gray-500 hover:text-red-700 cursor-pointer"><i class="fa-regular fa-circle-xmark"></i></button>
    </div>
